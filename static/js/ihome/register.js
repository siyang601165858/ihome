...
function generateImageCode() {
    // 新的要请求的图片验证码的编号
    var newImageCodeId = generateUUID();
    var imageCodeUrl = "/api/piccode?cur_pic_id="+newImageCodeId+"&pre_pic_id=" + imageCodeId;
    $(".image-code>img").attr("src", imageCodeUrl);
    imageCodeId = newImageCodeId;
}
...
function sendSMSCode() {
    ...
    var req_data = {
        mobile: mobile,
        piccode_id: imageCodeId,
        piccode_text: imageCode,
    };
    $.ajax({
